...
slug: /instrumentation/datadog/python-django-gunicorn
---
...
1. Configure the tracer to send traces to CubeAPM directly.
   ...
   <Tabs>
      <TabItem value="env" label="Environment Variables">
         ...
         ddtrace-run gunicorn sample_app.wsgi -c gunicorn.conf.py
         ```
      </TabItem>
   </Tabs>
...
A working example is available at: https://github.com/cubeapm/sample_app_python_django_gunicorn/tree/datadog.
...
2. Follow these configuration to send traces to CubeAPM:
   ...
   <Tabs>
      <TabItem value="env" label="Environment Variables">
         ...
         gunicorn sample_app.wsgi -c gunicorn.conf.py
         ```
      </TabItem>
   </Tabs>
